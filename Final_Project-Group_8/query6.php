...
<div class="container">
  <div class="jumbotron" style="opacity: 0.9; color: white">
	...
	<tr>
	<td>
		<p style="color: orange">Find all pokemon owned by Trainer_Name</p>
		<?php
		...
		$result = mysqli_query($conn,"SELECT pokemon_name, owner, iv, hp, cp FROM pokemon FULL JOIN trainer_account ON owner = trainer_account.trainer_name");
