...
<div class="container">
  <div class="jumbotron" style="opacity: 0.9; color: white">
	...
	<tr>
	<td>
		<p style="color: orange">“Find all Pokemon who have a greater Attack than average for their respective owners”</p>
		<?php
		...
		$result = mysqli_query($conn,"SELECT pokemon_name,owner, move2,attack  FROM Pokemon as P WHERE Attack > ( SELECT AVG(Attack) FROM Pokemon as P WHERE P.Owner = Owner)");
