...
<div class="container">
  <div class="jumbotron" style="opacity: 0.9; color: white">
	...
	<tr>
	<td>
		<p style="color: orange">Find all Pokemon with a greater CP than Snorlax</p>
		<?php
		...
		$result = mysqli_query($conn,"SELECT pokemon_name, type, cp FROM pokemon WHERE cp > ANY ( SELECT cp FROM pokemon WHERE pokemon_name = 'Snorlax') GROUP BY type");
