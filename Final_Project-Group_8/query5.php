...
<div class="container">
  <div class="jumbotron" style="opacity: 0.9; color: white">
	...
	<tr>
	<td>
		<p style="color: orange">“Find all trainers who own more than 1 fire type pokemon”</p>
		<?php
		...
		$result = mysqli_query($conn,"SELECT DISTINCT trainer_name FROM trainer_account, pokemon WHERE (SELECT COUNT(*) FROM Trainer_Account as T, Pokemon as P WHERE T.Trainer_Name = P.Owner AND P.Type = 'Fire') > 1");
