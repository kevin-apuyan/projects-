...
<div class="container">
  <div class="jumbotron" style="opacity: 0.9; color: white">
	...
	<tr>
	<td>
		<p style="color: orange">Find the quantities of pokemon owned by trainers at level 35</p>
		<?php
		...
		$result = mysqli_query($conn,"SELECT num_pokemon, trainer_name FROM trainer_account WHERE trainer_level=35");
